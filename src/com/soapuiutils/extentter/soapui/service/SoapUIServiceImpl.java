...
public class SoapUIServiceImpl implements SoapUIService {
	...
	public void startReporting(String reportPath, String reportName) {
		try {
			...
			SoapUI.log("SOAPUIUtils Extentter Error in  startLaunch of StepBasedSoapUIServiceImpl " + t.getMessage());
		}
	}
	...
	public void startTestCaseLogging(String testCaseName, String testSuiteId, String testCaseId) {
		try {
			...
			SoapUI.log("SOAPUIUtils Extentter Error in  startTestCase of StepBasedSoapUIServiceImpl " + t.getMessage());
		}
	}
	...
	public void startTestStepLogging(TestStep testStep, String testCaseId) {
		try {
			...
			SoapUI.log("SOAPUIUtils Extentter Error in  startTestStep of StepBasedSoapUIServiceImpl " + t.getMessage());
		}
	}
	...
	public void finishTestStepLogging(TestStepResult testStepContext, String testSuiteId, String testCaseId) {
		try {
			...
			SoapUI.log("SOAPUIUtils Extentter Error in  finishTestStep of StepBasedSoapUIServiceImpl " + t.getMessage());
		}
	}
	...
	public void addEnvDetails(List<TestProperty> properties) {
		try {
			...
			SoapUI.log("SOAPUIUtils Extentter Error in  addEnvDetails of StepBasedSoapUIServiceImpl " + t.getMessage());
		}
	}
} 